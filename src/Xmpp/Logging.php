...
class Xmpp_Logging {
	...
	const LOGGING_ERROR   = 0;
	const LOGGING_WARNING = 1;
	const LOGGING_INFO    = 2;
	const LOGGING_DEBUG   = 3;
	const LOGGING_VERBOSE = 4;

	public function __construct($printout = False, $runlevel=LOGGING_INFO) {
	...
	function log($msg, $runlevel=Null) {
		if($runlevel === Null) $runlevel = self::LOGGING_INFO;
